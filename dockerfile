...
EXPOSE 6006
CMD bash
#docker run -v /data/sciebo/experiments/LearnedRadonFilters:/home/lrf_user/LearnedRadonFilters/runs -p 6006:6006 -t -i lrf
#conda activate LRF
#tensorboard --logdir=/home/lrf_user/LearnedRadonFilters/runs > /dev/null &
#python /home/lrf_user/LearnedRadonFilters/main.py

#TODO Install C++ compiler